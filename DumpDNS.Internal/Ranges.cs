...
public class Ranges
{
    ...
    public class Source
    {
        ...
        public List<(Family, string)> Sources { get; set; } = [];
    }
    ...
    public static void UpdateRanges()
    {
        ...
        File.WriteAllText(UpdatePath, JsonConvert.SerializeObject(NeedsUpdating));
    ...
    public static void LoadRanges()
    {
        ...
        var update = JsonConvert.DeserializeObject<DateTime>(File.ReadAllText(UpdatePath));
